...
group_messages = {
	...
	'ukr': {
        ...
        'greetings': {
            'AgADAgADZ6kxG1M_GEgG9RyquUvUI2sNMw4ABKAxDeypprsu6vkDAAEC': 'too too roo',
            'AgADAgADcKkxG1M_GEjreI6wBOGOEbjyAw4ABBkPSE0s3-GpBTYDAAEC': 'Так приємно бачити тебе тут :3',
            'AgADAgADZqkxG1M_GEhbsCHANCg0I5fxAw4ABJmllyr9HizxiTcDAAEC': 'Ну що, москалику? Поговоримо?',
            'AgADAgADZKkxG1M_GEjwXisVZpyDP6EQnA4ABJu3L-OB0-XEeVUBAAEC': 'Привіт! Чий Крим?',
            'AgADAgADAqkxG_p-GEis9A0U9P1IYEMPMw4ABFlO5Bi3IT-7aAABBAABAg': 'Не часто тут видно нові обличчя. Я бачу ти новенький, так? Якщо хочеш, можу швиденько проветсті для тебе екскурс',            
			'AgADAgADY6kxG1M_GEgdWoAgjNiZwBz3Mg4ABEfoLfr4Fi1p5PYDAAEC': 'Ласкаво просимо ня! Чим я можу тобі допомогти, ня? ',
            'AgADAgADYakxG1M_GEh1sx0Zy8UiLYIOnA4ABBDqVhsTK1f3MlwBAAEC': 'О, так, семпай. Співаєш ще цих смачних французьких булочок і випий чаю (а мені налий молочка, я так хочу пити)',
            'AgADAgADXakxG1M_GEgETQ9kYGr24tP4Mg4ABBFAi_nDhkZAH_cDAAEC': 'Рада тебе бачити, нам дорогий кожен новий учасник чату',
            'AgADAgADXKkxG1M_GEh5DvCplGu_dAHyAw4ABA6YcPzwdVQn3DADAAEC': 'Привіт, друже, так так, саме ти. Ласкаво просимо. Бажаємо тобі всього хорошого, але хокаге стану я !!! '
        },
...
group_commands = {
    'ru': {
        ...
        'restricted': {
            ...
            'new_user': {
                'read_only': 'Пользователь <a href="tg://user?id={user_id}">{user_name}</a> ограничен на {ban_time} час., т.к. включена опция строгости к новичкам. Отключается в настройках.\n',
	...
	'ukr': {
        'errors':{
            'not_enough_rights': 'Вибач, але я не можу вам допомогти в цьому, тому-що: <b>у вас недостатньо прав для вчинення цього діяння.</b>',
            'no_such_sticker': 'Вибач, але я не можу вам допомогти в цьому, тому-що: <b>цей стікер ще не заблокований.</b>',
            'no_args_provided': 'Вибач, але я не можу вам допомогти в цьому, тому-що: <b>не надано жодного аргументу.</b>',
            'not_restricted': 'Вибач, але я не можу вам допомогти в цьому, тому-що: <b>даний користувач не був обмежений.</b>',
            'global_not_banned': 'Вибач, але я не можу вам допомогти в цьому, тому-що: <b>даний користувач не знаходиться в Глобальному Бані</b>'
        },
